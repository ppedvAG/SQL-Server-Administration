...
--Max kann Sicht anlegen.. und dann Tabellendaten ábfragen aus dbo Schema, auf dem wir ihm gezielt den Zugriff verweigerten

--Grund: besitzverkettung: alles gehört demselben Benutzer dbo!!
